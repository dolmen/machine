...
Machine is a zero dependency runtime for highly concurrent Go applications. It is inspired by `[errgroup](https://pkg.go.dev/golang.org/x/sync/errgroup).[Group](v)` with extra bells & whistles:
